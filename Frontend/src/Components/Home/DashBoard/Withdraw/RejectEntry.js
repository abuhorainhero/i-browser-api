    ...
    return (
        <div className="row">
            ...
            <div className={props.sidebarActive ? "col-md-10" : "col-md-12"}>
                <DashboardHeader name={"Withdrawal Request Reject Entry"} />

                {/* {accessbility.rejectEntry === true ? ( */}

                <section className="container-fluid dashboard_content mt-4">

                    <div className="my-3">
                        <h2 className="text-center mb-4 mt-5">Reject Withdrawal Request's</h2>
...
export default connect(mapStateToProps)(RejectEntry);